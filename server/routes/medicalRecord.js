...
router.post("/medicalRecord", (request, response) => {
    const {mid,aid,prescription} = request.body  
    
    db.query(
      "INSERT INTO appointment(mid,aid,prescription) VALUES(?,?,?)",
      [mid,aid,prescription],
      (error, result) => {
